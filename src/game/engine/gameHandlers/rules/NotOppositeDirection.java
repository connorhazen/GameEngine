...
public class NotOppositeDirection implements Rules {
  ...
  public boolean canPerform(List<MutableCell> currCells) {
    for (MutableCell c : currCells) {
      if ((c.getDirection().equals("LEFT") && newDir.equals("RIGHT")) || (
          c.getDirection().equals("RIGHT") && newDir.equals("LEFT")) ||
          (c.getDirection().equals("UP") && newDir.equals("DOWN")) || (
          c.getDirection().equals("DOWN") && newDir.equals("UP"))) {
        return false;
      }
    }
    return true;
